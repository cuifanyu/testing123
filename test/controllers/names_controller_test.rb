...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { msg: @name.msg, number: @name.number, title: @name.title } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { msg: @name.msg, number: @name.number, title: @name.title } }
